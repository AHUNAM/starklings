## Chidinma's Cairo Learning Repo – Starklings Exercises Completed 🤭

> This repository is a personal fork of [shramee/starklings](https://github.com/shramee/starklings) used to practice and complete interactive Cairo 1.0 exercises. It documents my personal progress through the interactive tutorial designed to teach Cairo 1.0 — the language used to build smart contracts for StarkNet.
...
### 🔹 Intro Section
- [x] `intro1.cairo` – Removed `// I AM NOT DONE` to validate default structure
- [x] `intro2.cairo` – Wrote a valid `main()` function

### 🔹 Variables Section
- [x] `variables1.cairo` – Declared `x` properly and added missing semicolon in `println!`
- [x] `variables2.cairo` – Declared `x` as an immutable value to resolve expression error
- [x] `variables3.cairo` – Assigned value to `x: felt252` to fix compilation error
...
I plan to resume from here in my next session.

---

## ▶️ How to Resume
To continue from where I left off, I simply run:
...
📌 Notes
This fork is actively maintained to document my hands-on experience with Cairo 1.0. It’s part of my broader blockchain development journey, and I’m using it to build confidence in writing provable, composable smart contracts on StarkNet.

Feel free to follow my journey or fork this repo to start yours 🤭🤭🤭
